...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title                  ="NoCodesNASDAQ"; // Document name
ulong                    Expert_MagicNumber            =30255;           //
...
input int                Signal_RVI_PeriodRVI          =8;               // Relative Vigor Index(8) Period of calculation
input double             Signal_RVI_Weight             =1.0;             // Relative Vigor Index(8) Weight [0...1.0]
//--- inputs for trailing
